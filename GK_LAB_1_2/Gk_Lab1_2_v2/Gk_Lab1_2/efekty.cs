...
namespace Graf_kom
{
    public partial class f_graf_kom
    {
        ...
        public void Efekt1()
        {
            //efekt: przesuwanie siê obrazu w kierunku prawej strony
        ...
        public void Efekt2()
        {
            //efekt: przewijanie siê obrazu wzd³u¿ przek¹tnej ekranu w kierunku górnego lewego wierzcho³ka
        ...
        public void Efekt3()
        {
            //efekt: zas³anianie pionowego obrazu w kierunku górnej krawêdzi ekranu
        ...
        public void Zmien_obraz()
        {
            ...
            */
            ...
            brightnessLabel.Text = "Jasnoœæ: " + brightnessP + "%";
        ...
        //public double DetermineBrightnessRGB()

        public double DetermineBrightnessHLS(Bitmap inputImage) //do sprawdzenia
        {
        ...
        public double DetermineBrightnessRGB(Bitmap inputImage) //do zmiany
        {
            int M = inputImage.Width;
            int N = inputImage.Height;
            int J = 0;
        ...
        public double DetermineContrastRGB(Bitmap inputImage, int brightness) //do zmiany
        {
            int M = inputImage.Width;
            int N = inputImage.Height;
            double J = brightness;
